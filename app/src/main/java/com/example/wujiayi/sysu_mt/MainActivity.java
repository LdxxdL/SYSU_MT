...
public class MainActivity extends FragmentActivity implements
    ...
    private Class fragmentArray[] = { Fragment_movie.class, Fragment_cinime.class,
            Fragment_myinfo.class };
    private int imageViewArray[] = { R.drawable.tab_home_btn, R.drawable.tab_view_btn,
            R.drawable.tab_myinfo_btn};
    ...
    private void initPage() {
        ...
        Fragment_cinime fragment_cinime = new Fragment_cinime();
        Fragment_myinfo fragment_myinfo = new Fragment_myinfo();

        list.add(fragment_movie);
        list.add(fragment_cinime);
